...
const AutoTradeButton = () => {
  ...
  return (
    <div
      ...
      className="fixed bottom-[115px] max-sm:bottom-[190px] z-5 left-1/2 max-sm:mx-auto -translate-x-1/2 text-center bg-transparent sm:hover:bg-primary/5 rounded-xl border border-primary/60 text-white shadow-lg py-2 px-8 max-sm:px-6 cursor-pointer"
    >
      View Auto Trade
