...
const BuySellButtons = ({ className }: { className?: string }) => {
  ...
  return (
    <div
      className={`flex flex-1 max-sm:mb-2 max-sm:bg-[#070f17] max-sm:w-full max-sm:flex max-sm:justify-center max-sm:flex-0 max-sm:px-3 ${className}`}
    >
      <button
...
export default function ControlPanel() {
  ...
  return (
    <>
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 flex bg-[#070f17] max-sm:w-full max-sm:flex max-sm:justify-center max-sm:items-center max-sm:rounded-none max-sm:relative max-sm:mt-auto max-sm:bottom-0 max-sm:gap-2 max-sm:border-none rounded-lg overflow-hidden text-white shadow-lg p-3">
        {/* Trade Amount Panel */}
