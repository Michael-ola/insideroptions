      ...
      <div className="bg-[#0E1514] text-white rounded-xl border border-primary/20 w-full max-w-md py-8 relative shadow-xl flex flex-col gap-6">
        ...
        <div className="px-8 pt-6 space-y-8">
          ...
          <div className="flex items-center justify-between gap-2 pb-8">
            <button
              onClick={onCancel}
              className="flex-1 border border-primary text-primary py-3 px-6 rounded-xl hover:bg-green-500/10 transition"
            >
              Cancel
            </button>
            <button
              ...
              className="flex-1 bg-primary text-black font-semibold py-3 px-6 rounded-xl hover:bg-green-300 transition"
            >
              Confirm
            </button>
          </div>
