...
const Section1 = () => {
  return (
    <section className="relative pb-20 flex bg-[#000510] pt-[10%]">
      <div className="absolute top-[30%] right-[8%] z-[1] w-[65%] h-[273px] bg-[#99E39E] blur-[1073.97px]"></div>
      <div className="absolute top-[40%] right-[15%] z-[2] w-[232px] h-[264px] bg-[#99E39E] blur-[476.71px]"></div>
      <Image
        ...
        alt="img"
      />
      <div className="w-1/2 pl-[7%] text-white">
      ...
      <div className="relative w-1/2 overflow-x-clip">
        <Image
          className=" absolute left-0 my-auto z-10 h-[520px]  w-[290px] animate-up-down"
          width={332}
          height={679}
        ...
        />
        <Image
          className="absolute left-[19%] top-5 z-10 h-[650px] animate-down-up"
          width={461}
          height={912}
